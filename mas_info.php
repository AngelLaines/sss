...
if (isset($_SESSION['usuario'])) {
  ...
  $sql = "select * from info_persona where folio=".$folio;
  $res = $conn->query($sql);
    ...
    <div id='top'>
      ...
      <div id="div_center">
        <table id="info">
          ...
          <tr>
            <th colspan="2">Software:<br/><textarea rows="2" cols="30" disabled style="resize:none"><?php echo $software; ?></textarea></th>
            <th ></th>
          </tr>
          <tr>
            <th colspan="2">Problema:<br/><textarea rows="2" cols="30" disabled style="resize:none"><?php echo $problema; ?></textarea></th>
            <th ></th>
          </tr>
          <tr>
